// TODO: 我们有时会鼓励你在弄懂某个练习之后，继续尝试更多修改。
// 如果所有代码都能正常运行，并且你已准备好进入下一个练习，
// 请在终端键入 `n` 并回车。
//
// 当修改了下面这些代码行中的某一行时，练习文件将会重新加载！
// 试着添加一个新的 `println!`，然后再看看它在终端输出了什么。
...
fn main() {
    ...
    println!("ctrl+左键单击练习文件路径(深蓝色字样)来在编辑器中打开它们。");
}
